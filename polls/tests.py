...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """was_published_recently reterns False for questions whose pub_date is in the Future"""
...
def create_question(question_text, days):
    """Create a question with the given 'question_text' and the given number of 'days'
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        ...
        self.assertContains(response, "No polls are availeable.")
